...
- `CONTRIBUTING.md` (AI-first workflow, DCO, coding guidelines)
- `CODE_OF_CONDUCT.md` (Contributor Covenant)

**Note:** This project follows a strict **AI-First Policy**. All source code changes must be generated by AI agents via task prompts. See `CONTRIBUTING.md` for details.
