...
[![TCK](https://img.shields.io/badge/TCK%20Level%202-100%25-success)](dat/tck-baselines/2.1.2/)
...
**API Stability:**
- Version 2.1.2 released: Memory allocation optimizations + critical crash fix
