...
namespace orion::bre
{
    ...
    json ASTNode::evaluate(const json& context, const orion::bre::feel::EvaluationContext& eval_ctx) const
    {
        switch (type)
        {
        ...
        case ASTNodeType::FUNCTION_CALL:
        {
            ...
            try {
                args = feel::bind_parameters(funcName, parameters, context, eval_ctx);
