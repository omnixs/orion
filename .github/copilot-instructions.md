...
This file is an **agent runbook** (process + verification rules). It intentionally avoids duplicating architecture, dependency lists, and user-facing docs.

- Architecture: see `docs/architecture.md`
- Testing & TCK: see `docs/testing.md` and `.github/instructions/`
- Public usage/API examples: prefer `README.md` and headers under `include/orion/`
