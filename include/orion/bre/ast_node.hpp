...
namespace orion::bre
{
    ...
    struct ASTNode
    {
         ...
         * @param eval_ctx Evaluation context with engine resources (optional for backward compatibility)
         ...
         * ```
         */
        [[nodiscard]] json evaluate(const json& context, orion::bre::feel::EvaluationContext* eval_ctx = nullptr) const;
    };
